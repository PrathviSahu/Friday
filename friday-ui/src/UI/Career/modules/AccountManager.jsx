...
const PLATFORMS = [
  ...
  { key: 'internshala_email', label: 'Internshala', icon: '🎓', field_type: 'email' },
  { key: 'internshala_password', label: 'Internshala', icon: '🎓', field_type: 'password' },
  ...
  { key: 'glassdoor_email',   label: 'Glassdoor',   icon: '🏢', field_type: 'email' },
  { key: 'glassdoor_password',label: 'Glassdoor',   icon: '🏢', field_type: 'password' },
  { key: 'foundit_email',     label: 'Foundit (Monster)', icon: '🌐', field_type: 'email' },
  { key: 'foundit_password',  label: 'Foundit (Monster)', icon: '🌐', field_type: 'password' },
  { key: 'hirist_email',      label: 'Hirist',      icon: '⚡', field_type: 'email' },
  { key: 'hirist_password',   label: 'Hirist',      icon: '⚡', field_type: 'password' },
