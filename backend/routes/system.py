...
@router.post("/open-app", dependencies=[Depends(require_boss)])
...
@router.post("/close-app", dependencies=[Depends(require_boss)])
...
@router.post("/system/display/brightness", dependencies=[Depends(require_boss)])
...
@router.post("/system/display/dark-mode", dependencies=[Depends(require_boss)])
...
@router.post("/system/display/volume", dependencies=[Depends(require_boss)])
...
@router.post("/system/display/mute", dependencies=[Depends(require_boss)])
...
@router.post("/system/display/lock", dependencies=[Depends(require_boss)])
