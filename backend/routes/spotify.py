...
@router.post("/spotify/seek", dependencies=[Depends(require_public_demo)])
...
@router.post("/spotify/duck", dependencies=[Depends(require_public_demo)])
...
@router.post("/spotify/unduck", dependencies=[Depends(require_public_demo)])
